--
-- File generated with SQLiteStudio v3.4.17 on Sun Oct 26 23:20:55 2025
--
...
-- Table: games
CREATE TABLE IF NOT EXISTS games (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, name TEXT (60) NOT NULL, publisher INTEGER REFERENCES companies (id) NOT NULL, developer INTEGER REFERENCES companies (id) NOT NULL, release_date TEXT (10) NOT NULL, score INTEGER, length REAL);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (1, 'The Elder Scrolls V: Skyrim', 1, 2, '2011-11-11', NULL, 110.0);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (2, 'Dishonored', 1, 4, '2012-10-09', NULL, 18.5);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (3, 'Dishonored 2', 1, 4, '2016-11-11', 87, 23.0);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (4, 'Prey', 1, 4, '2017-05-05', 81, 28.0);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (5, 'Doom', 1, 5, '2016-05-13', 86, 16.5);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (6, 'Doom Eternal', 1, 5, '2020-03-20', 89, 20.5);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (7, 'Wolfenstein: The New Order', 1, 6, '2014-05-20', 82, 15.2);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (8, 'Wolfenstein II: The New Colossus', 1, 6, '2017-10-27', 87, 17.0);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (9, 'StarCraft', 9, 9, '1998-03-31', NULL, 27.5);
INSERT INTO games (id, name, publisher, developer, release_date, score, length) VALUES (10, 'StarCraft II: Wings of Liberty', 9, 9, '2010-07-27', NULL, 21.5);
